...
<div class="container">
    ...
    <form name="Cadastro" action="consultaLivro" method="get">
    ...
    <table>
        ...
        <tr>
            ...
            <%
                String autorNome = (livroConsulta.getAutor() != null) ? livroConsulta.getAutor().getNome() : "Autor não encontrado";
            %>
            <td><%= autorNome %></td>
            ...
            <td class="action-buttons">
                ...
                <form action="excluir" method="get">
                    <input type="hidden" name="Id" value="<%= livroConsulta.getId() %>">
                    <input type="hidden" name="status" value="<%= livroConsulta.isAtivo() %>">

                    <br/>
                    <%if(livroConsulta.isAtivo()) {%>
                    <input type="submit" value="Inativar"/><br/>
                    <%}else{ %>
                    <input type="submit" value="Ativar"/><br/>
                    <%} %>
